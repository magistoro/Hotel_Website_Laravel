  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <a href="{{route('admin.amenity.create')}}" class="btn btn-primary">Добавить</a>
    </div>
    <div class="card-body">
    ...
    <tbody>
      ...
      <tr class="odd" onclick="window.location='{{ route('admin.amenity.show', $amenity->id) }}';" style="cursor: pointer">
        <td class="dtr-control sorting_1" tabindex="0">{{$amenity->id}}</td>
        <td>{{$amenity->title}}</td>
        </tr>
      @endforeach
    </tbody>
