  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <a href="{{route('admin.ticket.create')}}" class="btn btn-primary">Добавить</a>
    </div>
    <div class="card-body">
    ...
    <tbody>
      ...
      <tr class="odd" onclick="window.location='{{ route('admin.ticket.show', $ticket->id) }}';" style="cursor: pointer">
        <td class="dtr-control sorting_1" tabindex="0">{{$ticket->id}}</td>
        <td>{{$ticket->title}}</td>
        </tr>
      @endforeach
    </tbody>
